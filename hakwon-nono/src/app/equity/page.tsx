    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
          ...
          <h1 className="text-sm font-medium text-gray-600">접근성 격차 분석</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 mb-6">
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              <label className="text-sm font-medium text-gray-700">시도 선택</label>
              <select
                value={sido}
            ...
            {/* 반경 선택 */}
            <div className="flex items-center gap-3">
              <label className="text-sm font-medium text-gray-700">분석 반경</label>
        ...
        {data && !isLoading && (
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm text-gray-500">분석 학교 수</p>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-red-200 p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm text-gray-500">사각지대 학교</p>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm text-gray-500">평균 접근 학원 수</p>
                </div>
                <p className="text-3xl font-bold text-gray-900">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm text-gray-500">접근성 충분 비율</p>
                </div>
                <p className="text-3xl font-bold text-gray-900">
            ...
            {/* 접근성 분포 차트 */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-1">접근성 분포</h3>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {blindSpotSchools.slice(0, 100).map((school) => (
                        <tr key={school.id} className="hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 text-sm text-gray-500 hidden md:table-cell max-w-xs truncate">
                            {school.address}
                          </td>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span
                              className={`inline-flex px-2.5 py-1 rounded-full text-xs font-medium ${
                                ACCESS_LEVEL_BADGE[school.accessLevel] || 'bg-gray-100 text-gray-600'
                              }`}
                            >
                              {school.accessLevel}
                            </span>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-blue-900 mb-2">분석 요약</h4>
